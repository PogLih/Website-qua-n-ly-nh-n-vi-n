			...
			<form method="post" action="admin/user/add-user.htm" name="submitForm"
				...
				<div class="form-group my-3" data-plugin="formMaterial">
					...
					<input type="text" class="form-control validated" id="inputText"
						name="username" placeholder="Text" required>
				...
				<div class="form-group my-3" data-plugin="formMaterial">
					...
					<input type="password" class="form-control validated"
						id="inputPassword" name="password" placeholder="Text" required>
				...
				<div class="form-group my-3" data-plugin="formMaterial">
					...
					<input type="text" class="form-control validated"
						id="inputFullname" name="fullName" placeholder="Text" required>
